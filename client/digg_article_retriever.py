...
"""Retrives articles from Digg with all their comments in a single page.
...
__all__ = ['ArticleRetriever', 'InvalidDiggCommentPage']
...
class ArticleRetriever(object):
    ...
    It will download an article page with it's comments. If an article page was
    broken into multiple comments page it will retrieve all of them and merge
